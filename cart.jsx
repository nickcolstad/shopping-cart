...
const Products = props => {
  ...
  // Me trying to figure out Strapi data and how to access the object I want
  const cartData = JSON.stringify(data);
  console.log(`Rendering Products ${cartData}`);
  ...
  const photos = ["photos/apple.png", "photos/orange.png", "photos/beans.png", "photos/cabbage.png"];
    ...
    return (
      <Card key={index}>
        ...
        <Accordion.Collapse onClick={() => deleteCartItem(index)} eventKey={1 + index}>
          <Card.Body>
            <Button>Delete Item</Button> $ {item.cost}
          </Card.Body>
        </Accordion.Collapse>
      </Card>
    );
  ...
  // Where I need to grab the right objects so I can destructure then return.
